...
Welcome to `jiraclui` contributor's guide.
...
If you experience bugs or general issues with `jiraclui`, please have a look
...
You can help improve `jiraclui` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`jiraclui` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `jiraclui`'s files. While this mechanism can
...
```
conda create -n jiraclui python=3 six virtualenv pytest pytest-cov
conda activate jiraclui
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/jiraclui.git
   cd jiraclui
   ```
...
5. Install [pre-commit]:
   ...
   `jiraclui` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/jiraclui
[issue tracker]: https://github.com/<USERNAME>/jiraclui/issues
